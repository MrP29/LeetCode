...
class Solution {
    ...
    public int search(int[] nums, int target) {
        ...
        return Math.max(searchHelper(0, pivot - 1), searchHelper(pivot, nums.length - 1));
    }
...
//One-pass Iterative Binary Search by LeetCode (Time: O(logN) Space: O(1))
class Solution {
    public int search(int[] nums, int target) {
        int min = 0;
